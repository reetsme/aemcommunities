...
%><%@include file="/libs/granite/ui/global.jsp" %><%
    ...
    if(contentResourceContext != null) {
        ...
        List<Resource> configResourcesContext = confMgrContext.getListResources("community/badging/rules");
    ...
    if(contentResourceGlobal !=  null) {
        ...
        List<Resource> configResourcesGlobal = confMgrGlobal.getListResources("community/badging/rules");
    ...
    final Resource contentResourceApps = resourceResolver.getResource("/apps/settings/community/badging/rules");
    ...
    final Resource contentResourceLibs = resourceResolver.getResource("/libs/settings/community/badging/rules");
    ...
    // load ootb rules :  from /etc : Pre 6.4 path
    final Resource contentResourceEtc = resourceResolver.getResource("/etc/community/badging/rules");
