...
(function (document, $) {
    ...
    var relCreateConfig = ".social-create-config-facebook";
    var uniqueConfigNodeName = "facebookconnect";
    ...
    function openCreate() {
        ...
        if(activeItem !=undefined){
            ...
            location.href = Granite.HTTP.externalize("/libs/social/connect/facebook/content/configurations/createfacebookconfig.html"+contentPath);
        }
    }
