...
(function (document, $) {
    ...
    var relCreateConfig = ".social-create-config-pinterest";
    var uniqueConfigNodeName = "pinterestconnect";
    ...
    function openCreate() {
        ...
        if(activeItem !=undefined){
            ...
            location.href = Granite.HTTP.externalize("/libs/social/connect/pinterest/content/configurations/createpinterestconfig.html"+contentPath);
        }
    }
